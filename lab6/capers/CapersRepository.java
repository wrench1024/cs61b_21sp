...
public class CapersRepository {
    ...
    static final File CAPERS_FOLDER = join(".capers", "story.txt");
    ...
    public static void setupPersistence() {
        ...
        File storyFile = new File(dir, "story.txt");
        try {
    ...
    public static void writeStory(String text) {
        // TODO
        String curStory = readContentsAsString(CAPERS_FOLDER);
        writeContents(CAPERS_FOLDER, curStory, text, "\n");
    ...
    public static void celebrateBirthday(String name) {
        ...
        File dogFile = new File(Dog.DOG_FOLDER, name);
        writeObject(dogFile, thisDog);
    }
}
